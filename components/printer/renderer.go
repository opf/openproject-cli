...
type Renderer interface {
	...
	WorkPackageDetails(*models.WorkPackageInspectPayload)
	WorkPackageCreatePlan(*models.WorkPackageCreatePlan)
	WorkPackageUpdatePlan(*models.WorkPackageUpdatePlan)
