...
func Inspect(id uint64) (*models.WorkPackageInspectPayload, error) {
...
func InspectWithChildren(id uint64) (*models.WorkPackageInspectPayload, error) {
...
func children(parentID uint64) ([]models.WorkPackageSummary, error) {
